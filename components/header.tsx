...
const header: VFC = () => {
    return (
        <header>
            <div className=' fixed backdrop-filter backdrop-sepia top-0 z-5 w-full flex items-center justify-between flex-wrap p-2 animate-animated animate-fadeIn animate-delay'>
